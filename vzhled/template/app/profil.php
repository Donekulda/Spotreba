<?php
    ...
    if(GetVariable($_SESSION['id'], "uzivatele", "opravneni") <= 0 or !isset($_SESSION['id'])){
  ...
  <body>
                ...
                <div class="row row-xs mg-t-30">
                  ...
                  <div class="col-sm-6 mg-l-auto mg-r-0">
                    <div class="form-layout-footer">
                      <button id="changePassBtn" onclick="ZmenaHesla()" name="zmena" class="btn btn-info mg-r-5" disabled><i class="fa fa-send mg-r-10"></i>Změnit</button>
    ...
    <script>
      function ZmenaHesla(){
        ...
        var newPassAgain = document.getElementById("passForm").value;

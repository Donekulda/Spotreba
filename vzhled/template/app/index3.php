...
?>
      ...
      <div class="am-pagebody">
          <div class="row row-sm">
              <div class="col-xl-6">
                  <div class="card pd-20 pd-sm-40">
                    <h4 style="text-align:center; color:black;"><strong>Fáze 1</strong></h4>
                    <img style="width: 100%;"  src="http://spotreba.solarnivyroba.cz/plugins/grafy/grafm.php?faze=1&amp;max=<?=$max?>&amp;od=<?=$_SESSION["mesic2"]."-".$_SESSION["rok2"]?>">  
                  </div><!-- card -->
              </div><!-- col-6 -->
              <div class="col-xl-6">
                  <div class="card pd-20 pd-sm-40">
                    <h4 style="text-align:center; color:black;"><strong>Fáze 2</strong></h4>
                    <img style="width: 100%;" src="http://spotreba.solarnivyroba.cz/plugins/grafy/grafm.php?faze=2&amp;max=<?=$max?>&amp;od=<?=$_SESSION["mesic2"]."-".$_SESSION["rok2"]?>">  
                  </div><!-- card -->
              </div><!-- col-6 -->
          </div><!-- row -->
          ...
          <div class="row row-sm mg-t-15 mg-sm-t-20">
              <div class="col-xl-6">
                  <div class="card pd-20 pd-sm-40">
                    <h4 style="text-align:center; color:black;"><strong>Fáze 3</strong></h4>
                    <img style="width: 100%; " src="http://spotreba.solarnivyroba.cz/plugins/grafy/grafm.php?faze=3&amp;max=<?=$max?>&amp;od=<?=$_SESSION["mesic2"]."-".$_SESSION["rok2"]?>">  
                  </div><!-- card -->
              </div><!-- col-6 -->
              <div class="col-xl-6">
                  <div class="card pd-20 pd-sm-40">

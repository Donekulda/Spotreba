<?php
  ...
  if($_SESSION["den"] != date("j") || $_SESSION["mesic"] != date("n") || $_SESSION["rok"] != date("Y")){
    $inform_text = "Denní";
  }
...
?>
    ...
    <script>
     ...
     window.onload = function () {
      <?php 
        $faze1 = CreateGraf("Faze1", 1, $od, $max, GetVariable($_SESSION['show_ip'], "ip_adresy", "Nazev_Faze1"));
        $faze2 = CreateGraf("Faze2", 2, $od, $max, GetVariable($_SESSION['show_ip'], "ip_adresy", "Nazev_Faze2"));
        $faze3 = CreateGraf("Faze3", 3, $od, $max, GetVariable($_SESSION['show_ip'], "ip_adresy", "Nazev_Faze3"));

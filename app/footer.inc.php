...
<script>
    ...
    $.datepicker.setDefaults($.datepicker.regional['cs']);
      ...
      <div class="am-footer">
        <a href="../docs/<?php echo GetVariable(3, "Dokumenty", "file_name"); ?>" target="_blank">Pomoc</a>
        <a href="../GDPR/<?php echo GetVariable(1, "Dokumenty", "file_name"); ?>" target="_blank">GDPR</a>
        <a href="../docs/<?php echo GetVariable(2, "Dokumenty", "file_name"); ?>" target="_blank">Podmínky použití</a>
        <a href="../docs/<?php echo GetVariable(4, "Dokumenty", "file_name"); ?>" target="_blank">Kontakt</a>
      </div>
